...
<?php	
	...
	?>
	  ...
	  <div class="boxrow" class="caption right-align">
        ...
        <th><?php echo e(trans('messages.display.department')); ?></th>
        <?php elseif($displaysetting->columnflag==2): ?>
        <th><?php echo e(trans('messages.display.doctor')); ?></th>
        <?php elseif($displaysetting->columnflag==3): ?>
        <th><?php echo e(trans('messages.display.department')); ?></th>
        <th><?php echo e(trans('messages.display.doctor')); ?></th>
        <?php else: ?> <?php endif; ?>
        
		<th><?php echo e(trans('messages.display.dtoken')); ?></th>
		<th><?php echo e(trans('messages.display.roomnumber')); ?></th>
		<th><?php echo e(trans('messages.display.work')); ?></th>
		</tr>
		</thead>
		<tbody>
		...
		<td><?php echo e($displaysetting->work); ?></td>
		</tr>
		<?php } ?>
		</tbody>
		</table>
