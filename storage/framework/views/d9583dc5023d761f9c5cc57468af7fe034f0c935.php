...
<?php $__env->startSection('content'); ?>
    ...
    <!----End-sms-on-mobile--------> 
        ...
        <li><?php echo e(trans('messages.users.token_number')); ?> : <?php echo e(session()->get('number')); ?> </li>
            ...
            <?php if(session()->has('dispensary')): ?> 
            <div class="popuptoken referrralbox"> 
            <div class="tknpopupbox">
            <ul>
        <li>Your Pharmacy <?php echo e(trans('messages.users.token_number')); ?> : <?php echo e(session()->get('number')); ?>  (<?php echo e(session()->get('registration_no')); ?>) Please proceed to pharmacy to collect your medicine</li> 
           </ul> 
            </div>
            <div>
            <?php endif; ?>
...
<!-------------------------------------------->
      ...
      <!------------------------------->              
           ...
           <?php if($pdepartments->id == ''): ?> <a style="color:red">Not Allotted</a>  <?php else: ?> <?php echo e($pdepartments->name); ?>  <?php endif; ?>
            ...
            <div class="col s12 m6 l6">
            <div class="doctordetails">
            <span><?php echo e(trans('messages.roomnumber')); ?> :</span>
            <span>
...
<!-------------------------> 
			...
			<div class="row">
             ...
             <?php if($user->department_id !== $queuesetting->dispensary_id): ?>  <th><?php echo e(trans('messages.actions')); ?></th> <?php endif; ?>
                            </tr>
                        </thead>
                        <tbody>
...
<a style="cursor:not-allowed" class="disabled btn-floating waves-effect waves-light btn blue tooltipped" href="javascript:void(0)" data-position="top" data-tooltip="Press ON to display Patient Token Number"> <i class="mdi-av-timer"></i></a>
        ...
        <?php if($user->department_id !== $queuesetting->dispensary_id): ?> <!---start-if-for-user-dept-and-kiosk-dept--->

        <?php if($queuesetting->tokendisplay==2): ?>

             <?php if($patient->doctor_work_start == 1): ?>
             <a class="modal-trigger dispensorybutton" href="#modaldispensary_<?php echo e($patient->id); ?>">Dispensary</a>
            <?php else: ?>
            <a class="btndisabled dispensorybutton" href="javascript:void(0);">Dispensary</a>
            <?php endif; ?>
        <!-------Start-Dispensary-doctor-popup--------------> 

        <div id="modaldispensary_<?php echo e($patient->id); ?>" class="custom-modal modal">
                <div class="modal-content">
                <div class="customform">
                <h4>Token No. : <?php echo e($patient->number); ?> </h4>
                <h3>Please proceed to pharmacy to collect your medicine</h3>
            <form id="modaldispensary2_<?php echo e($patient->id); ?>" name="modaldispensary2_<?php echo e($patient->id); ?>" action="/" method="GET">
      ...
      <?php if($patient->queue->pmobile !== NULL): ?>
                    <input class="pmobile_<?php echo e($patient->id); ?>"  name="pmobile" type="hidden" value="<?php echo e($patient->queue->pmobile); ?>"  />
         <?php else: ?> 
         <input autocomplete="off" autofocus id="pmobilevd" class="pmobilevd_<?php echo e($patient->id); ?>"  name="pmobilevd" placeholder="Enter Mobile Number" maxlength="10" type="text" value=""  />
     <?php endif; ?>              
       
       <!------------------------>
        <input class="pemail_<?php echo e($patient->id); ?>" name="pemail" type="hidden" value="<?php echo e($patient->queue->pemail); ?>"  />
        <input class="dispensaryflag_<?php echo e($patient->id); ?>" name="dispensaryflag" type="hidden" value="M"  />   
             <!------------------------------->  
               
            <div class="row refboxmrg">
                        <div class="input-field col s12">
                            <label for="disdoctor" class="active"><?php echo e(trans('messages.select')); ?> Dispensary Counter</label>
                            <select id="disdoctor" class="browser-default disdoctor_<?php echo e($patient->id); ?>" name="disdoctor" data-error=".disdoctor">
							<option value=""><?php echo e(trans('messages.select')); ?> Dispensary Counter</option>
							<?php $__currentLoopData = $activedoctordispensary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activedispdoctor): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                           
        <option value="<?php echo e($activedispdoctor->id); ?>">
        <?php $dr_room = ''; if(!empty($activedispdoctor->counter_id))
               ...
               ?>
        <?php echo e($activedispdoctor->name); ?> &#8596; <?php echo e($activedispdoctor->department->name); ?> &#8596; ( <?php echo e($dr_room); ?> )
        </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
							</select>
                            <div class="doctor">
               ...
               <button class="btn waves-effect waves-light csfloat subbutton" onclick="send_to_dispensary(<?php echo e($patient->id); ?>); this.style.visibility='hidden'; this.disable=true;" style="text-transform:none; margin-left:10px;">SEND TO DISPENSARY<i class="mdi-navigation-arrow-forward right"></i>
                </button>
            </div>
                </div>
                </div>
        ...
        <!----IF-not-mobile------->
            <?php if($patient->queue->pmobile !== NULL): ?>
            <a class="dispensorybutton" href="<?php echo e(url('/dashboard/endCounterdisp_department')); ?>/<?php echo e($patient->id); ?>">Dispensary</a>
            <?php else: ?> 
            <a class="modal-trigger dispensorybutton" href="#modaldispensarydepartment_<?php echo e($patient->id); ?>">Dispensary</a>
            <?php endif; ?>
        <!-----IF-not-mobile-------->
            <?php else: ?>
            <a class="btndisabled dispensorybutton" href="javascript:void(0);">Dispensary</a>
        ...
        <div id="modaldispensarydepartment_<?php echo e($patient->id); ?>" class="custom-modal modal">
                <div class="modal-content">
                <div class="customform">
                <h4>Token No. : <?php echo e($patient->number); ?> </h4>
                <h3>Please proceed to pharmacy to collect your medicine</h3>
            <form id="modaldispensarydepartment_<?php echo e($patient->id); ?>"  action="<?php echo e(url('dashboard/endCounterdisp_departmentdirect')); ?>/<?php echo e($patient->id); ?>" method="GET">
            <?php echo e(csrf_field()); ?>

            <div class="row refboxmrg">
                        <div class="input-field col s12">
                            <label for="pmobilenumber" class="active">Enter 10 Digit Mobile Number</label>
                    <input autocomplete="off" autofocus id="pmobilenumber_<?php echo e($patient->id); ?>"  name="pmobilenumber" placeholder="Enter Mobile Number" maxlength="10" type="text" value="" />
                            <div class="pmobile">
                                <?php if($errors->has('pmobilenumber')): ?><div class="error"><?php echo e($errors->first('pmobilenumber')); ?></div><?php endif; ?>
                            </div>
                        </div>
                    </div>
        ...
        <?php endif; ?>
                             ...
                             <?php endif; ?>   <!---end-if-for-user-dept-and-kiosk-dept--->
         <!--------------------Start-Dispensary-button-&-Popup-------------------->
                           ...
                           <!-----------Referral-Review---------------->  
                           <?php if($user->department_id !== $queuesetting->dispensary_id): ?>     
                                  <td>
                                  <?php
...
<a style="font-size:10px;cursor:not-allowed" class="disabled btn-floating waves-effect waves-light btn pink tooltipped" href="javascript:void(0)" data-position="top" data-tooltip="Review"> <i class="mdi-editor-mode-edit"></i></a>
        ...
        <?php $dr_room = ''; if(!empty($activerefdoctor->counter_id))
               ...
               ?>
        <?php echo e($activerefdoctor->name); ?> &#8596; <?php echo e($activerefdoctor->department->name); ?> &#8596; ( <?php echo e($dr_room); ?> )
        </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
							</select>
                            <div class="doctor">
...
<?php if(session()->has('dispensary_doctor')): ?>
    <style>#printarea{display:none;text-align:left}@media  print{#loader-wrapper,header,#main,footer,#toast-container{display:none}#printarea{display:block;}}@page{margin:0}</style>
<div id="printarea" style="background:#ffffff; -webkit-print-color-adjust:exact; font-family: 'Open Sans', sans-serif; line-height:1.2;  position:relative;">
          <!------------------>     
   ...
   <tr><td colspan="2" style="text-align:center; padding:5px 0;"><span style="display:inline-table; font-weight:800; border:2px dotted #000; color:#000; padding:4px; text-transform:uppercase; font-size:25px;">टोकन संख्या : <?php echo e(session()->get('number')); ?>  <sup><?php echo e(session()->get('patient_type')); ?></sup></span>
   ...
   <tr> <td style="width:70%; padding:4px; border:1px solid #ccc;">Doctor Name (डॉक्टर नाम) <span style="float:right;">:</span></td> <td style="width:30%; padding:4px; border:1px solid #ccc;"><?php echo e(session()->get('doctor_name')); ?></td> </tr>
   <tr> <td style="width:70%; padding:4px; border:1px solid #ccc;">Room No. (कमरा संख्या) <span style="float:right;">:</span></td> <td style="width:30%; padding:4px; border:1px solid #ccc;"><?php echo e(session()->get('room_number')); ?></td> </tr>

   <tr> <td style="width:70%; padding:4px; border:1px solid #ccc;">Department Name (विभाग<br> का नाम) <span style="float:right;">:</span></td> <td style="width:30%; padding:4px; border:1px solid #ccc;"><?php echo e(session()->get('dispensary')); ?></td> </tr>
   ...
   <tr> <td style="padding:4px; border:1px solid #ccc;">Date (दिनांक) <span style="float:right;">:</span></td>  <td style="padding:4px; border:1px solid #ccc;"> <?php echo e(\Carbon\Carbon::now()->format('d-m-Y')); ?></td> </tr>
   <tr> <td style="padding:4px; border:1px solid #ccc;">Time (समय) <span style="float:right;">:</span></td>  <td style="padding:4px; border:1px solid #ccc;"><?php echo e(\Carbon\Carbon::now()->format('h:i:s A')); ?></td> </tr>
   <tr> <td style="padding:4px; border:1px solid #ccc;">Send By <span style="float:right;">:</span></td>  <td style="padding:4px; border:1px solid #ccc;"><?php echo e(session()->get('referred_by')); ?></td> </tr>
...
<?php if(session()->has('dispensary_department')): ?>
    <style>#printarea{display:none;text-align:left}@media  print{#loader-wrapper,header,#main,footer,#toast-container{display:none}#printarea{display:block;}}@page{margin:0}</style>
<div id="printarea" style="background:#ffffff; -webkit-print-color-adjust:exact; font-family: 'Open Sans', sans-serif; line-height:1.2;  position:relative;">
          <!------------------>     
   ...
   <tr> <td style="padding:4px; border:1px solid #ccc;">Patient Name (रोगी का नाम) <span style="float:right;">:</span></td>  <td style="padding:4px; border:1px solid #ccc;"><?php echo e(session()->get('patient_pname')); ?></td> </tr>
